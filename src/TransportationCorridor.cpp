 ...
 * @param damage [int] damage inflicted by the opposing side on the transportation of this country.
 */
double TransportationCorridor::damageSummary(int t, int damage){
	cout<<"DAMAGE SUMMARY:"<<endl;
	double x=damage/t*100;
	cout<<"\t"<<x<<"% of the transportation damaged."<<endl;
}
