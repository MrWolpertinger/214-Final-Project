...
void RealModeWarSimulation::warloop(){
	...
	int xA=0;
	int yB=0;
	cout<<countryGroups[0]->Allies.size()<<endl;
	cout<<countryGroups[1]->Allies.size()<<endl;
...
void RealModeWarSimulation::check(int x,int y){
	cout<<"size: "<<countryGroups[0]->Allies.size()<<endl;
	cout<<"size: "<<countryGroups[1]->Allies.size()<<endl;
